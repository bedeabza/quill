...
enum MeetTileEvidence {
    static func tiles(_ nodes: [MeetTileNode]) -> [MeetSpeakerTile] {
        ...
        for index in nodes.indices {
            ...
            result.append(MeetSpeakerTile(indicatorIndex: index, nameIndex: nameIndex, name: name,
